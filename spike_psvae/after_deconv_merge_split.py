...
def get_templates_com(templates, geom, n_channels=12):
    ...
    for i in range(n_templates):
        ...
        x_z_templates[i] = (templates[i].ptp(0)[mc-n_chan_half:mc+n_chan_half]*geom[mc-n_chan_half:mc+n_chan_half])/templates[i].ptp(0)[mc-n_chan_half:mc+n_chan_half].sum()
